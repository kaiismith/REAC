    ...
    def start(self):
        ...
        for FILE_NAME in self.FILE_NAMES:
            ...
            while cap.isOpened:
                ...
                with open("r_gaze_axis.txt", "a") as file:
                    file.write(f"[{datetime.now()}]: [{r_gaze_axis[2][0][0] - r_corner[0]}, {r_gaze_axis[2][0][1] - r_corner[1]}]\n")

                with open("r_axis.txt", "a") as file:
                    file.write(f"[{datetime.now()}]: [{r_axis[0]} {r_axis[1]} {r_axis[2]}]\n")

                with open("l_gaze_axis.txt", "a") as file:
                    file.write(f"[{datetime.now()}]: [{l_gaze_axis[0]} {l_gaze_axis[1]} {l_gaze_axis[2]}]\n")

                with open("l_axis.txt", "a") as file:
                    file.write(f"[{datetime.now()}]: [{l_axis[0]} {l_axis[1]} {l_axis[2]}]\n")
                
                # temp.append(r_gaze_axis[0])
                # print(r_gaze_axis)
